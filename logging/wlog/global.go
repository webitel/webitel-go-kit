...
// GloballyDisableDebugLogForTest DON'T USE THIS Modify the level on the app logger
func GloballyDisableDebugLogForTest() {
	globalLogger.consoleLevel.SetLevel(zapcore.ErrorLevel)
}

// GloballyEnableDebugLogForTest DON'T USE THIS Modify the level on the app logger
